...
| FR-09 | V1 | US-12, US-13, US-14 | [#12](https://github.com/Joaconz/Biyu/issues/12) | **Ajustado**: de 1 a 12 cuotas, no de 2 a 24 (`roadmap.md` §V1; valores límite 0, 1, 2, 12, 13 en `07-plan-de-testing.md` §3). El schema todavía no tiene el tope: entra en [#70](https://github.com/Joaconz/Biyu/issues/70) |
